...
const Header = () => {
  ...
  return (
    ...
    <header className="bg-success fixed top-0 py-2.5 w-full z-10">
      ...
      <div className="w-full  sm:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center flex-1">
          <Link className="h-7 mr-1 sm:mr-4 text-black" to="/">
          My ecommerce
          </Link>
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          ...
          {isAuthenticated === false ?
            ...
            :
            (
              <span className="userDropDown flex items-center text-primary-blue font-medium gap-1 cursor-pointer" onClick={() => setTogglePrimaryDropDown(!togglePrimaryDropDown)}>{user.name && user.name.split(" ", 1)}
          ...
          <span className="moreDropDown hidden sm:flex items-center text-black font-medium gap-1 cursor-pointer" onClick={() => setToggleSecondaryDropDown(!toggleSecondaryDropDown)}>More
          ...
          <Link to="/cart" className="flex items-center text-blue font-medium gap-2 relative">
